...
| `clawshire --output json ...` | 返回结构化 JSON 供脚本或 Agent 处理 |
...
clawshire --output json notice stock 000001 --start-date 2026-04-01 --end-date 2026-04-20
clawshire --output json notice stock 603402 --start-date 2026-04-01 --end-date 2026-04-20 --page-all
```
